...
public class House
{
    ...
    String[] totalHouseList = {"Mansion", "Beach House", "Cottage", "Farm House", "Villa", "Castle", "Igloo", "Condominium", "Town House", "Log Cabin", "Manor"};
    ...
    /*
    public House(int bValue, int mortgage)
    {
        this.buyValue = bValue;
        this.yearlyHousePayment = mortgage;
    }

    public Apartment(int deposit, int yCharge)
    {
        this.initialDeposit = deposit;
        this.yearlyApartmentCharge = yCharge;
    }
    */
    
    // Provides house options if 18+ with 3 homes, each at a different tier of prices, and checks if they can afford it and if they can, they buy the house with responsibilties
    ...
    public void houseOptions()
    {
        if(p.getAge > 18)
        {
            ...
            System.out.println("Choice 1: " + expensiveHouseList[option1] + " for $" + price1 + " with an initial downpayment of " + price1/10 + " and a fixed yearly mortgage of " + ((price1 - price1/10)/30); + " due at the end of each year");
            System.out.println("Choice 2: " + regularHouseList[option2] + " for $" + price2 + " with an initial downpayment of " + price2/10 + " and a fixed yearly mortgage of " + ((price2 - price2/10)/30); + " due at the end of each year"); 
            System.out.println("Choice 3: " + cheapHouseList[option3] + " for $" + price3 + " with an initial downpayment of " + price3/10 + " and a fixed yearly mortgage of " + ((price3 - price3/10)/30); + " due at the end of each year"); 
    ...
    public void payYearly()
    {
        if(house == true)
        {
            ...
            System.out.println("You payed $" + yearlyHousePayment + " towards your home and you still have :" + (buyValue - amountPayed) + "left to pay on the mortgage");
        }
    ...
    // Called upon when asked if they want a house/apartment at the end of each year and chose house
    ...
    //Called upon when asked if they want a house/apartment at the end of each year and chose apartment
    public void rentApartment()
    {
        p.removeMoney(initialDeposit);
        System.out.println("Congratulations! You rented an apartment and put in a non-refundable deposit of : $" + initialDeposit + "down on the apartment");
        apartment = true;
    }

    // If they wish to sell the house they own they'll recieve 90% of the initial value
    public void sellHouse()
    {
        if(house == true)
        {
            p.addMoney((buyVaue*.9));
            house = false;
        }
        else
        {
    ...
    // Checks at end of year for living situations and adds to health based on what sleeping arrangements they have (scaled)
